...
中医经典问诊框架参考 《十问歌》，并结合现代人群的养生需求补充细节，具体分为 6 大类核心要素：**基础信息、寒热感受、饮食与脾胃功能、睡眠与精神状态、情绪、生活习惯与诱因**。据此设计了一套由**主诉输入** + **核心状态与局部症状判断** + **补充说明**三部分组成的中医问诊模块。
...
在开发过程中，我是如何快速了解中医辨证的基本逻辑并将其应用于提示词设计的？

下面是一份**可直接粘进 README「三、快速学习心得」**的完整内容，语气偏**真实复盘 + 方法总结**，既不像课程笔记，也不像“我百度了中医”，而是**AI 产品视角下的快速学习路径**。
