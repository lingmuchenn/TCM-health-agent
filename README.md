...
一款**非诊疗、以日常养生为核心**的中医智能助手，通过简化的“类问诊”交互，帮助用户理解自身当前的身体状态倾向，并给出可执行、低风险、贴近日常生活的养生建议。
...
通过查阅中医问诊相关资料，能够提炼出以下结论：

中医并不急于给出疾病名称，而是通过寒热、虚实、气机、脏腑功能等维度，描述一个**动态的身体状态组合**（即“证”）。

这一认知直接影响了产品设计的两个关键决策，贯穿问诊与输出全流程：

* **问诊逻辑聚焦“状态倾向”**：所有问答设计均围绕“身体状态特征”展开，而非引导用户自我判断“疾病类型”，避免因专业认知差异导致的偏差；
* **输出结论强调“可能性表述”**：在健康分析结果中，统一使用“可能倾向于”“表现为”等非确定性表述，既符合中医辨证“动态调整”的核心逻辑，也规避了非专业场景下的绝对化医疗风险。
